...
import { CreateReceiver } from '@/features/fiat/CreateReceiver';
import { ReceiverHub } from '@/features/fiat/ReceiverHub';
  ...
  if (!adult) {
    return (
      <div className="scr screen col pb-104">
        <BackBar title={store.t('fiat.tab')} onBack={store.goBack} />
