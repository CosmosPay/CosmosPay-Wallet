...
import { PrimaryButton, GhostButton, BackBar, Spinner } from '@/ui/parts';
...
import { Field } from '@/features/fiat/components/Field';
import { Select } from '@/features/fiat/components/Select';
import { QuoteRow } from '@/features/fiat/components/QuoteRow';
import { DepositInstructions } from '@/features/fiat/components/DepositInstructions';
...
export function Deposit({ store }: { store: WalletStore }) {
  ...
  const tokens = stableTokens(store.account); // a trusted stablecoin is needed to receive the mint
