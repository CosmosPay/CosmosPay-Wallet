      ...
      {step === 0 && (
        <>
          ...
          <div className="flexr g10">
            ...
            <div className="f1"><Field tone="soft" label={t('fiat.lastName')} value={lastName} onChange={setLastName} /></div>
          </div>
          ...
          <Field tone="soft" label={t('fiat.taxId')} value={taxId} onChange={setTaxId} placeholder={t('fiat.taxIdPlaceholder')} />
          <Field tone="soft" label={t('fiat.dob')} value={dob} onChange={setDob} type="date" />
          <Field tone="soft" label={t('fiat.address')} value={addr} onChange={setAddr} />
          <div className="flexr g10">
            <div className="fiat-flex-14"><Field tone="soft" label={t('fiat.city')} value={city} onChange={setCity} /></div>
            <div className="f1"><Field tone="soft" label={t('fiat.region')} value={region} onChange={setRegion} /></div>
