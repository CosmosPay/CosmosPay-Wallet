...
import { PrimaryButton, GhostButton, BackBar, EnableReceivingCard } from '@/ui/parts';
import { CosmosPayRow } from '@/features/cosmos-pay/components/CosmosPayRow';
import { CosmosPayEnvRow } from '@/features/cosmos-pay/components/CosmosPayEnvRow';
import { ageFromBirthdate } from '@/lib/greeting';
import '@/styles/features/cosmos-pay/cosmos-pay.css';
