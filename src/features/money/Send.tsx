...
import { AssetPicker } from '@/features/money/components/AssetPicker';
import { spendableXlm } from '@/features/money/shared';
      ...
      <div className="send-amount">
        ...
        <div className="center g12">
          <input
            ...
            style={{ '--chars': Math.max(1, s.amount.length || 1) } as React.CSSProperties}
          />
