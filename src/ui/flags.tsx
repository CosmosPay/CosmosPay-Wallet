    ...
    <div ref={ref} className="flag-select">
      <button onClick={() => setOpen((o) => !o)} className="row g8 flag-select-btn">
        ...
        <span
          ...
          className={`flag-select-caret ${open ? 'is-open' : ''}`}
        >
          ▼
        </span>
      </button>
          ...
          {LANGUAGES.map((l) => {
            ...
            return (
              <button
                ...
                className={`row g10 flag-select-opt ${on ? "is-on" : ""}`}
