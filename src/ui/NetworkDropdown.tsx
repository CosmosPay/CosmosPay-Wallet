...
import { StellarMark } from '@/ui/StellarMark';
import '@/styles/ui/network-dropdown.css';
    ...
    <div className="network-dd">
      ...
      {open && (
        <>
          ...
          <div className="glass network-dd-menu" className={`glass network-dd-menu align-${align}`}>
            {store.networks.map((n) => {
              ...
              return (
                <div
                  ...
                  className={`row g10 network-dd-row ${on ? 'is-on' : ''}`}
                >
                  <StellarMark size={14} />
