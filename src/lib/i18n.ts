...
export const T: Record<string, Record<Lang, string>> = {
  ...
  'defindex.minorUnits': { es: 'Ingresá unidades mínimas del activo (7 decimales). La confirmación valida exactamente estos límites.', en: 'Enter asset minor units (7 decimals). Confirmation verifies these exact limits.', pt: 'Introduz unidades mínimas do ativo (7 decimais). A confirmação verifica exatamente estes limites.', de: 'Gib Asset-Untereinheiten ein (7 Dezimalstellen). Die Bestätigung prüft genau diese Limits.', fr: 'Saisis les unités minimales de l’actif (7 décimales). La confirmation vérifie exactement ces limites.' },
