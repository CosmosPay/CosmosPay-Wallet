...
const T: Record<string, Record<Lang, string>> = {
  ...
  'fiat.noTokenVerified': { es: 'No se pudo verificar el token del retiro.', en: 'Couldn’t verify the withdrawal token.', pt: 'Couldn’t verify the withdrawal token.', de: 'Couldn’t verify the withdrawal token.', fr: 'Couldn’t verify the withdrawal token.' },
