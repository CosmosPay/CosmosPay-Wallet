...
export const T: Record<string, Record<Lang, string>> = {
  ...
  'pollar.noKey': { es: 'Necesitás conectar Cosmos Pay antes de entrar con una cuenta social.', en: 'You need to connect Cosmos Pay before signing in with a social account.', pt: 'Precisa de ligar o Cosmos Pay antes de entrar com uma conta social.', de: 'Sie müssen Cosmos Pay verbinden, bevor Sie sich mit einem sozialen Konto anmelden.', fr: 'Vous devez connecter Cosmos Pay avant de vous connecter avec un compte social.' },
