...
export const T: Record<string, Record<Lang, string>> = {
  ...
  'pollar.localBadge': { es: 'En este dispositivo', en: 'On this device', pt: 'Neste dispositivo', de: 'Auf diesem Gerät', fr: 'Sur cet appareil' },
  'pollar.localWarning': { es: 'En testnet la clave se genera acá y no sale del dispositivo: Pollar no la custodia. La frase de recuperación queda guardada y podés verla en Ajustes.', en: 'On testnet the key is generated here and never leaves the device: Pollar does not custody it. The recovery phrase is stored and you can view it in Settings.', pt: 'Na testnet a chave é gerada aqui e não sai do dispositivo: a Pollar não a guarda. A frase de recuperação fica guardada e pode vê-la nas Definições.', de: 'Im Testnet wird der Schlüssel hier erzeugt und verlässt das Gerät nicht: Pollar verwahrt ihn nicht. Die Wiederherstellungsphrase wird gespeichert und ist in den Einstellungen einsehbar.', fr: 'Sur le testnet, la clé est générée ici et ne quitte pas l’appareil : Pollar ne la conserve pas. La phrase de récupération est enregistrée et consultable dans les Réglages.' },
  'pollar.localDesc': { es: 'Entrás con tu cuenta y el wallet crea la clave Stellar en este dispositivo. En mainnet, en cambio, la custodia Pollar.', en: 'You sign in with your account and the wallet creates the Stellar key on this device. On mainnet, Pollar custodies it instead.', pt: 'Entra com a sua conta e a wallet cria a chave Stellar neste dispositivo. Na mainnet, a Pollar é que a guarda.', de: 'Sie melden sich mit Ihrem Konto an und die Wallet erzeugt den Stellar-Schlüssel auf diesem Gerät. Im Mainnet verwahrt ihn dagegen Pollar.', fr: 'Vous vous connectez avec votre compte et le portefeuille crée la clé Stellar sur cet appareil. Sur le mainnet, c’est Pollar qui la conserve.' },
