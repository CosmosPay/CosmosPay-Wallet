...
export const T: Record<string, Record<Lang, string>> = {
  ...
  'earn.protocols': { es: 'Protocolos de rendimiento', en: 'Yield protocols', pt: 'Protocolos de rendimento', de: 'Renditeprotokolle', fr: 'Protocoles de rendement' },
  'earn.openProtocol': { es: 'Entrar al protocolo', en: 'Open protocol', pt: 'Entrar no protocolo', de: 'Protokoll öffnen', fr: 'Accéder au protocole' },
  'earn.defindexKind': { es: 'Vaults', en: 'Vaults', pt: 'Vaults', de: 'Vaults', fr: 'Vaults' },
  'earn.defindexDesc': {
    es: 'Vaults automatizados que distribuyen tus fondos entre estrategias de rendimiento en Stellar.',
    en: 'Automated vaults that allocate your funds across yield strategies on Stellar.',
    pt: 'Vaults automatizados que distribuem os teus fundos entre estratégias de rendimento na Stellar.',
    de: 'Automatisierte Vaults, die deine Mittel auf Renditestrategien auf Stellar verteilen.',
    fr: 'Des vaults automatisés qui répartissent tes fonds entre des stratégies de rendement sur Stellar.',
  },
  'defindex.intro': { es: 'Invertí y retirate de vaults DeFindex sin salir de Cosmos Wallet. Revisamos el contrato y cada monto antes de firmar.', en: 'Invest in and withdraw from DeFindex vaults without leaving Cosmos Wallet. We verify the contract and every amount before signing.', pt: 'Investe e retira de vaults DeFindex sem sair da Cosmos Wallet. Verificamos o contrato e cada valor antes de assinar.', de: 'Investiere in DeFindex-Vaults und ziehe Mittel ab, ohne Cosmos Wallet zu verlassen. Vertrag und Beträge werden vor dem Signieren geprüft.', fr: 'Investis et retire des vaults DeFindex sans quitter Cosmos Wallet. Le contrat et chaque montant sont vérifiés avant signature.' },
  'defindex.vault': { es: 'Vault', en: 'Vault', pt: 'Vault', de: 'Vault', fr: 'Vault' },
  'defindex.assets': { es: 'activos', en: 'assets', pt: 'ativos', de: 'Assets', fr: 'actifs' },
  'defindex.deposit': { es: 'Invertir', en: 'Deposit', pt: 'Investir', de: 'Einzahlen', fr: 'Investir' },
  'defindex.withdraw': { es: 'Retirar', en: 'Withdraw', pt: 'Retirar', de: 'Auszahlen', fr: 'Retirer' },
  'defindex.amount': { es: 'Monto', en: 'Amount', pt: 'Valor', de: 'Betrag', fr: 'Montant' },
  'defindex.shares': { es: 'Shares a retirar', en: 'Shares to withdraw', pt: 'Shares a retirar', de: 'Abzuhebende Shares', fr: 'Parts à retirer' },
  'defindex.minorUnits': { es: 'Ingresá el monto normal del activo. Podés usar hasta 7 decimales; la wallet convierte y valida el valor exacto.', en: 'Enter the normal asset amount. You can use up to 7 decimals; the wallet converts and verifies the exact value.', pt: 'Introduz o valor normal do ativo. Podes usar até 7 decimais; a wallet converte e verifica o valor exato.', de: 'Gib den normalen Asset-Betrag ein. Bis zu 7 Dezimalstellen sind möglich; die Wallet konvertiert und prüft den exakten Wert.', fr: 'Saisis le montant normal de l’actif. Tu peux utiliser jusqu’à 7 décimales ; la wallet convertit et vérifie la valeur exacte.' },
  'defindex.position': { es: 'Posición actual', en: 'Current position', pt: 'Posição atual', de: 'Aktuelle Position', fr: 'Position actuelle' },
  'defindex.confirmDeposit': { es: 'Revisar e invertir', en: 'Review and deposit', pt: 'Rever e investir', de: 'Prüfen und einzahlen', fr: 'Vérifier et investir' },
  'defindex.confirmWithdraw': { es: 'Revisar y retirar', en: 'Review and withdraw', pt: 'Rever e retirar', de: 'Prüfen und auszahlen', fr: 'Vérifier et retirer' },
  'defindex.success': { es: 'Operación DeFindex enviada', en: 'DeFindex operation submitted', pt: 'Operação DeFindex enviada', de: 'DeFindex-Vorgang gesendet', fr: 'Opération DeFindex envoyée' },
  'defindex.loadError': { es: 'No se pudieron cargar los vaults', en: 'Could not load vaults', pt: 'Não foi possível carregar os vaults', de: 'Vaults konnten nicht geladen werden', fr: 'Impossible de charger les vaults' },
  'defindex.submitError': { es: 'No se pudo enviar la operación', en: 'Could not submit the operation', pt: 'Não foi possível enviar a operação', de: 'Vorgang konnte nicht gesendet werden', fr: 'Impossible d’envoyer l’opération' },
  'defindex.enableTitle': { es: 'Activá CosmosPay', en: 'Enable CosmosPay', pt: 'Ativa o CosmosPay', de: 'CosmosPay aktivieren', fr: 'Active CosmosPay' },
  'defindex.enableDesc': { es: 'DeFindex usa el gateway modular de CosmosPay para preparar y enviar transacciones, mientras tu clave queda en el dispositivo.', en: 'DeFindex uses the modular CosmosPay gateway to prepare and submit transactions while your key stays on the device.', pt: 'A DeFindex usa o gateway modular CosmosPay para preparar e enviar transações, enquanto a tua chave fica no dispositivo.', de: 'DeFindex nutzt das modulare CosmosPay-Gateway zum Erstellen und Senden, während dein Schlüssel auf dem Gerät bleibt.', fr: 'DeFindex utilise la passerelle modulaire CosmosPay pour préparer et envoyer les transactions, tandis que ta clé reste sur l’appareil.' },
  'defindex.enable': { es: 'Configurar CosmosPay', en: 'Set up CosmosPay', pt: 'Configurar CosmosPay', de: 'CosmosPay einrichten', fr: 'Configurer CosmosPay' },
  'earn.blendKind': { es: 'Lending', en: 'Lending', pt: 'Empréstimos', de: 'Kreditmarkt', fr: 'Prêt' },
  'earn.blendDesc': {
    es: 'Prestá activos en mercados de crédito descentralizados y obtené interés variable.',
    en: 'Lend assets in decentralized credit markets and earn variable interest.',
    pt: 'Empresta ativos em mercados de crédito descentralizados e recebe juros variáveis.',
    de: 'Verleihe Assets auf dezentralen Kreditmärkten und erhalte variable Zinsen.',
    fr: 'Prête des actifs sur des marchés de crédit décentralisés et perçois un intérêt variable.',
  },
  'earn.etherfuseKind': { es: 'Bonos', en: 'Bonds', pt: 'Títulos', de: 'Anleihen', fr: 'Obligations' },
  'earn.etherfuseDesc': {
    es: 'Explorá Stablebonds respaldados por deuda soberana tokenizada, según disponibilidad regional.',
    en: 'Explore Stablebonds backed by tokenized sovereign debt, subject to regional availability.',
    pt: 'Explora Stablebonds lastreados por dívida soberana tokenizada, conforme a disponibilidade regional.',
    de: 'Entdecke Stablebonds, die durch tokenisierte Staatsanleihen gedeckt sind, je nach regionaler Verfügbarkeit.',
    fr: 'Explore les Stablebonds adossés à de la dette souveraine tokenisée, selon leur disponibilité régionale.',
  },
  ...
  'pollar.alsoTestnet': { es: 'Además se crea una wallet de testnet con la clave en este dispositivo, protegida con la misma contraseña. Son direcciones distintas.', en: 'A testnet wallet is also created, with its key on this device and the same password protecting it. They are different addresses.', pt: 'Também é criada uma wallet de testnet, com a chave neste dispositivo e protegida pela mesma palavra-passe. São endereços diferentes.', de: 'Zusätzlich wird eine Testnet-Wallet erstellt, deren Schlüssel auf diesem Gerät liegt und durch dasselbe Passwort geschützt ist. Es sind verschiedene Adressen.', fr: 'Un portefeuille testnet est aussi créé, avec sa clé sur cet appareil et protégée par le même mot de passe. Ce sont des adresses différentes.' },
  ...
  'pollar.verifyTitle': { es: 'Confirmá tu correo', en: 'Confirm your email', pt: 'Confirme o seu e-mail', de: 'Bestätigen Sie Ihre E-Mail', fr: 'Confirmez votre e-mail' },
  'pollar.verifyDesc': { es: 'Este correo ya tiene una cuenta de Cosmos Pay. Le enviamos un código de 6 dígitos: ingresalo para terminar de entrar. Si no iniciaste esta sesión vos, no se lo des a nadie.', en: 'This email already has a Cosmos Pay account. We sent it a 6-digit code: enter it to finish signing in. If you did not start this sign-in, do not give the code to anyone.', pt: 'Este e-mail já tem uma conta Cosmos Pay. Enviámos-lhe um código de 6 dígitos: introduza-o para concluir o início de sessão. Se não foi você que iniciou esta sessão, não dê o código a ninguém.', de: 'Für diese E-Mail gibt es bereits ein Cosmos-Pay-Konto. Wir haben einen 6-stelligen Code dorthin gesendet: Geben Sie ihn ein, um die Anmeldung abzuschließen. Wenn Sie diese Anmeldung nicht gestartet haben, geben Sie den Code an niemanden weiter.', fr: 'Cet e-mail a déjà un compte Cosmos Pay. Nous y avons envoyé un code à 6 chiffres : saisissez-le pour terminer la connexion. Si vous n’avez pas lancé cette connexion, ne donnez ce code à personne.' },
  ...
  'pollar.verifyCta': { es: 'Confirmar', en: 'Confirm', pt: 'Confirmar', de: 'Bestätigen', fr: 'Confirmer' },
