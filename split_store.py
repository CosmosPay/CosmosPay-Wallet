...
os.makedirs('src/state/slices', exist_ok=True)

ui_code = """import { useCallback, useMemo, useRef, useState } from 'react';
...
with open('src/state/slices/ui.ts', 'w') as f: f.write(ui_code)
